...
st.image("image/alandalus_fachada.jpg", caption="Transformación Digital - El Andalus", use_column_width=True)# Foto genérica de restaurante, cámbiala por una del local si tienes
